...
<body>
	<div class="container">
		...
		<form id="write-form" action="${pageContext.request.contextPath}/board/boardUpdateOk.bo" method="post" 
			enctype="multipart/form-data"><!--multipart/form-data 이진수로 저장하는 인코딩 타입 -->
			...
			<div class="form-group">
				...
				<div class="writer">
				<!--BoardWriteController에서 받아온 memberId 값 보여주기  -->
			...
			<div class="form-group">
				...
				<div class="image-upload-wrap">
					<input type="file" id="file" name="boardFile"
						accept=".jpg, .jpeg, .png" multiple /><!--accept 파일 확장자 정하기,multiple 여러개를 정할수있음  -->
